 ...
 * 		target/flink-quick-start-1.0-SNAPSHOT.jar
 * From the CLI you can then run
 * 		./bin/flink run -c com.fjn.flink.StreamingJob target/flink-quick-start-1.0-SNAPSHOT.jar
 *
